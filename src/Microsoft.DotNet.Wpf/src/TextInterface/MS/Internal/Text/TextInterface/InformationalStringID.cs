...
namespace MS.Internal.Text.TextInterface {
  ...
  public enum InformationalStringID {
    ...
    /// <summary>
    /// Description of the font. Can contain revision information, usage
    ...
    /// example scenarios for licensed use. This field should be written in
    ...
    /// <summary>
    /// GDI-compatible family name. Because GDI allows a maximum of four
    /// fonts per family, fonts in the same family may have different
    /// GDI-compatible family names (e.g., "Arial", "Arial Narrow", "Arial
    /// Black").
    /// </summary>
    WIN32FamilyNames,
    ...
    /// to group more than four fonts in a single family without losing
    /// compatibility with GDI. This name is typically only present if it
    /// differs from the GDI-compatible family name.
    /// </summary>
    PreferredFamilyNames,

    /// <summary>
    /// Subfamily name preferred by the designer. This name is typically
